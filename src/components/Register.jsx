...
const Register = () => {
  return (
    <div className="bg-gradient-primary loginContainer">
              ...
              <div className="col-lg-7">
                <div className="p-5">
                  ...
                  <form className="user">
                    ...
                    <hr />
                    <a className="btn btn-danger btn-google btn-user btn-block">
                      <i className="fab fa-google fa-fw" /> Register with Google
                    </a>
                    <a className="btn btn-facebook bg-primary-700 btn-user btn-block">
